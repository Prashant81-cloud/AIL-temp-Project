...
el.addEventListener("mouseleave", () => {
  ...
  return (
    <div className="flex px-15 w-[100vw] gap-44 relative intro-text">
      ...
      <div className="flex flex-col gap-34 h-150">
        ...
        <p
          ref={addTextRef}
          className="hover-text c1 w-130 text-3xl opacity-50 text-gray-900 cursor-pointer"
        >
      ...
      {/* RIGHT COLUMN */}
      <div className="flex flex-col gap-34 w-350">
        <h1 className="text-5xl font-semibold">
          India's New-Age Media & AI Storytelling Company
        </h1>

        <p ref={addTextRef} className="hover-text c2 text-xl font-medium cursor-pointer">
        ...
        <p ref={addTextRef} className="hover-text c3 text-xl font-medium cursor-pointer">
