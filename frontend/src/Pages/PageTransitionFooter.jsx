...
const App = () => {
  ...
  useEffect(() => {
    ...
    gsap.to(page1, {
      yPercent: -67, // only move up 50%, so half remains visible
      ease: "none",
      scrollTrigger: {
...
>
  ...
  <div className="relative z-1 text-center">
    <h1
      ...
      className="text-[12vw] tracking-[0.2em] leading-none text-[#faf4ec]"
    >
      ADVAITA
    </h1>
    <h2 className="text-[3vw] tracking-[15px] text-[#faf4ec]">
      INNOVATION LABS.
    </h2>
  </div>
</div>
