...
export default function FAQMobile() {
  const [selectedCategory, setSelectedCategory] = useState(0); // Default: About AIL
  ...
  return (
    <div className="w-full md:hidden px-6">
      ...
      <div className="font-bold leading-tight mb-6 archivo-black">
        <h1 className="text-3xl sm:text-4xl">Frequently</h1>
        <span className="block mt-2 text-[#5C8AC9] text-xl sm:text-2xl">
          Asked Questions
        </span>
      </div>
      ...
      <div className=" mb-6">
        ...
        <button
          ...
          className="w-full flex justify-between items-center  rounded-lg px-4 py-3 text-[0.9rem] font-semibold shadow-sm"
        >
        ...
        {/* Dropdown Menu */}
        {dropdownOpen && (
          <div className=" left-0 right-0 mt-2  rounded-lg shadow-lg ">
            {categories.map((cat, index) => (
              <button
                ...
                className={`w-full text-left px-4 py-1 text-base font-medium 
                   ${
        ...
        {categories[selectedCategory].questions.map((item, index) => (
          ...
          >
            ...
            <button
              ...
              className="w-full flex justify-between items-center text-base font-semibold text-left"
            >
              {item.question}
